...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_hhkb_wrapper(
      ...
      KC_LSFT, _________________QWERTY_L3_________________, _________________QWERTY_R3_________________, KC_RSFT, MO(RAISE),
      _______, KC_LALT, KC_LGUI,                             KC_SPACE,                                   KC_RGUI, KC_RALT, _______
  ),

  [_DVORAK] = LAYOUT_hhkb_wrapper(
      KC_ESC,  ________________NUMBER_LEFT________________, ________________NUMBER_RIGHT_______________, KC_MINS, KC_EQL,  KC_BSLS, KC_GRV,
      ...
      KC_LSFT, _________________DVORAK_L3_________________, _________________DVORAK_R3_________________, KC_RSFT, MO(RAISE),
      _______, KC_LALT, KC_LGUI,                             KC_SPACE,                                   KC_RGUI, KC_RALT, _______
  ),

  [_RAISE] = LAYOUT_hhkb_wrapper(
      RESET,  _________________FUNC_LEFT_________________, _________________FUNC_RIGHT________________, KC_F11,  KC_12,   KC_INS, KC_DEL,
