...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_ortho_5x15(
        ...
        _______, _______, _______, _______, _______, _______, RGB_HUD, RGB_SAD, RGB_VAD, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, \
        _______, _______, _______, _______, _______, _______, RGB_M_B, RGB_M_R, RGB_M_SW,_______, _______, _______, _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, RGB_SPI, RGB_SPD, RGB_M_G, _______, _______, _______, _______, _______, _______  \
    ),
