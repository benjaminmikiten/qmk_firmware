...
=======
  ...
  BACKLIT, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_ENT,  KC_SPC,  RAISE,   RGUI(KC_LEFT), RALT(KC_DOWN), KC_UP,   KC_RGHT  \
),
...
[_DVORAK] = LAYOUT_preonic_grid( \
  ...
  CTL_ESC, KC_A,    KC_O,    KC_E,    KC_U,    KC_I,    KC_D,    KC_H,    KC_T,          KC_N,    KC_S,    KC_QUOT, \
