...
#define LKSC C(G(KC_Q))
#define PXSNP G(S(A(KC_P)))
...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  LKSC,    KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_ENT,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  _______, PXSNP,   KC_MFFD, KC_VOLU, KC_BRK , KC_PGUP, _______, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
  _______, _______, KC_MRWD, KC_VOLD, KC_BRMD, KC_PGDN, _______, _______, _______, _______, _______, _______, \
  LKSC,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______  \
),
